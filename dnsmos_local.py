...
if __name__=="__main__":
    ...
    # testset_dir = "C:/Users/zikan/Uni/erasmus2026/PBLproject/RECORDINGS/roof-rec-1st/test_sets/dynamic_shield/25cm/output"
    # csv_path = None  # or r"C:\path\to\output.csv"
